# #/home/minjun/panda_mujoco_gym/train_sac_highlight2.py
# # /home/dyros/panda_mujoco_gym/train_sac_highlight2.py
...
class FixedEpisodeVideoRecorder:
    ...
    def end_episode_recording(self, episode_info: Dict) -> Optional[str]:
        ...
        '''
        filename = f"{stage}_ep{episode_id:03d}_{success_str}{task_str}_reward{reward:.1f}.mp4"
        ...
        if success:
            ...
            episode_info['version'] = version  # 버전 정보
...
class FixedConfig:
    ...
    video_fps = 20                 # 비디오 FPS
    max_episode_steps = 2000       # # 에피소드 최대 스텝 수 증가 (1000 → 2000)
    # 환경 개선 설정
    normalize_env = True
    reward_scale = 0.1
